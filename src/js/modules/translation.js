...
const _DEFAULT_LOCALE = 'en-US',
    _TRANSLATIONS = {
        'en-US': {
            ...
            'copy.notFound.body1': 'Whoops! The page you are looking for doesn’t exist.',
            'copy.notFound.body2': 'Please <a href="@link">click here</a> to go back to Neon.',
            'copy.notFound.body3': '(Error 404)',
            ...
            'copy.pendingAccount.body1': 'Almost there! Get ready to start creating higher performing video thumbnails.',
            'copy.pendingAccount.body2': 'Please check your email for account verification. If you don’t see an email, please check your spam & junk filters or trash folder.',
            'copy.pendingAccount.body3': 'Still don’t find it?  Please <a href="@link" rel="external">contact us</a>.',
            ...
            'copy.integrations.new.title': 'New Integration',
            'copy.integrations.new.heading': 'New Integration',
            'copy.integrations.new.body': 'TODO',
            ...
            // TODO 'copy.processingSlide.4': 'When Neon is done analyzing your video, your thumbnails will appear below. If you don’t want to wait, you can safely exit this page without interrupting the process and come back later to view the results. You will also get an email from Neon when your thumbnails are ready.',
            'copy.processingSlide.4': 'When Neon is done analyzing your video, your thumbnails will appear below. If you don’t want to wait, you can safely exit this page without interrupting the process and come back later to view the results.',
