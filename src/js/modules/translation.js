...
const _DEFAULT_LOCALE = 'en-US',
    _TRANSLATIONS = {
        'en-US': {
            ...
            // image upload page
            'imageUpload.dragInstructions.one': "First Let's name your photo collection",
            'imageUpload.dragInstructions.two': 'Now drag and drop your images into the window. Or you can use the buttons below to browse your device or Dropbox account.',
            'imageUpload.dragInstructions.three': 'You can continue uploading files to this collection. When you are done press submit below.',
            ...
            'imageUpload.or' : 'OR',
            'imageUpload.placeholderName': "Lets Start by naming your collection!",
