...
const _DEFAULT_LOCALE = 'en-US',
    _TRANSLATIONS = {
        'en-US': {
            ...
            'copy.lift.explanation.images': 'Lift is the percentage increase in clicks your collection would get by using your images with a high NeonScore.',
            ...
            'imageUpload.collectionCount': 'Each Collection can have up to 100 Images!',
            ...
            'imageUpload.imageError': 'The file type you have provided is either to large (<2.5MB) or the wrong format (jpeg, jpg, png, tiff, gif, bmp)',
