        ...
        return (
            <main className="xxPage">
                ...
                <div className="xxText">
                    <h1 className="xxTitle">{T.get('copy.telemetry.heading')}</h1>
                    {
                        (self.state.isBrightCoveGalleryIntegration) ? (
                        <div>
                            <h1 className="xxCollection-title">Brightcove Gallery integration</h1>
                            ...
                            <h1 className="xxCollection-title">Your custom Neon Telemetry Tag</h1>
                            <textarea
                                readOnly
                                className="textarea"
                            ...
                            <div>
                                <h1 className="xxCollection-title">Other Integrations</h1>
