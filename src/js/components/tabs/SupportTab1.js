...
var SupportTab1 = React.createClass({
    render: function() {
        ...
        return (
            ...
            <h1 className="xxSubtitle">Video Analysis</h1>
            ...
            <h1 className="xxSubtitle">Editorial Partnering</h1>
            ...
            <h1 className="xxSubtitle">Automated A/B Testing, Optimization, and Realtime Analytics</h1>
