    ...
    render: function() {
        ...
        return (
            <section className="xxText">
                ...
                <h1 className="xxSubtitle">Why do we need these permissions?</h1>
                ...
                <h1 className="xxSubtitle">New Brightcove Player</h1>
                ...
                <h1 className="xxSubtitle">Legacy Smart Player</h1>
                ...
                <h1 className="xxSubtitle">Self-managed site</h1>
                ...
                <h1 className="xxSubtitle">Gallery</h1>
