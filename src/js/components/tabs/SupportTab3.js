...
<pre className="wonderland-pre"><code>{`http://i2.neon-images.com/v1/client/12345/neonvid_video1.jpg?height=90&width=160`}</code></pre>
                ...
                <h4>Using Neon&rsquo;s Telemetry Tag</h4>
                ...
                <h5>1. Your thumbnails are inside an anchor tag. Each thumbnail can be either an img tag or a background-image css property. For example:</h5>
...
<pre className="wonderland-pre"><code>{`<a href="http://www.mysite.com/play_video1">
    <div style="background-image: url('http://i3.neon-images.com/v1/client/1234/neonvid_video1.jpg');"></div>
                ...
                <h5>2. Any click that causes the video to play resolves to the same location as the destination of the above anchor tag.</h5>
                ...
                <h4>Sending Your Own Beacons</h4>
