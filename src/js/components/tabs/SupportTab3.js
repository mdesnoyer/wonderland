    ...
    render: function() {
        ...
        return (
            <section className="xxText">
                ...
                <h1 className="xxCollection-title">1. Video Ingestion</h1>
...
<pre className="xxPre"><code className="xxCode">{`{
    ...
    "callback_url" : "http://myserver.com/neon"
                ...
                <h1 className="xxCollection-title">2. Image Serving</h1>
...
<pre className="xxPre"><code className="xxCode">{`http://i2.neon-images.com/v1/client/12345/neonvid_video1.jpg?height=90&width=160`}</code></pre>
                ...
                <h1 className="xxPage-Subtitle">Using Neon&rsquo;s Telemetry Tag</h1>
    ...
    <pre className="xxPre"><code className="xxCode">{`<a href="http://www.mysite.com/play_video1">
        <div style="background-image: url('http://i3.neon-images.com/v1/client/1234/neonvid_video1.jpg');"></div>
                ...
                <h1 className="xxPage-Subtitle">Sending Your Own Beacons</h1>
                ...
                <h1 className="xxPage-Subtitle">Events Collected</h1>
                ...
                <h1 className="xxCollection-title">Callbacks</h1>
                ...
                <table className="xxTable">
                    <thead>
                        <tr>
                            <th className="xxPage-Subtitle">Event</th>
                            <th className="xxPage-Subtitle">experiment_state</th>
                            <th className="xxPage-Subtitle">processing_state</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
