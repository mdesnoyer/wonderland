        ...
        return (
            <article className="xxPageOverlay-content">
                ...
                <div className="xxText">
                    ...
                    <p>In order to identify these features in your images, we import your videos or image collections, analyze individual frames or images using our proprietary neuroscience-based deep learning algorithms, and compare your image to similar images in our image library. Find out more about what’s going on behind the scenes in <a href="https://neon-lab.com/how-neon-works/">How It Works</a>.</p>
